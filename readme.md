...
2. Install [Docker](https://docs.docker.com/engine/install/ubuntu/) `sudo snap install docker` and [Nvidia Docker](https://github.com/NVIDIA/nvidia-docker#quickstart)
